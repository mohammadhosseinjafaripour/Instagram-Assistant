...
public class BioBottomDialogFragment extends BottomSheetDialogFragment {

    ImageView close_img;
    TextView bio_text;
    Button copy_bio;
    static BioBottomDialogFragment bioBottomDialogFragment;

    public static BioBottomDialogFragment newInstance() {
        bioBottomDialogFragment = new BioBottomDialogFragment();
